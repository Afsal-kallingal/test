...
urlpatterns = [
    ...
    # path('login-phone-pas/',login_phone_pass,name="login_phone_password"),
    ...
    path('resend-login-phone-otp/',resend_login_phone_otp,name="resend_phone_otp"),
